    ...
    <div className='min-h-screen bg-slate-50'>
      ...
      <div className='max-w-6xl mx-auto p-6'>
        ...
        <div className='mb-8'>
          ...
          <p className='text-slate-600'>Manage your network and make new connections</p>
        </div>
        {/* counts  */}
        <div className='mb-8 flex flex-wrap gap-6'>
          {
            dataArray.map((item,index)=>(
              <div className='flex flex-col items-center justify-center gap-1 boder h-20 w-40 border-gray-200 bg-white shadow rounded-md'>
